...
namespace ProjetoExcel
{
    public class GerarExcelGrafico
    {
        public string GerarExcel(string txtArquivoExcel)
        {
            ...
            return "O arquivo Excel foi criado e pode ser aberto em  c:\\dados\\GraficoExcel.xls";
        }
